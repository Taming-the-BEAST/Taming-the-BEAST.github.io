...
Both of these files have 50,000 trees, so it is helpful to thin the tree samples and summarize fewer states (to avoid hitting the maximum memory allotted for this program). Turn on \mi{Resample states at lower frequency} and set this value to 2000.
...
\begin{figure}[h!]
\centering
\fbox{\includegraphics[width=\textwidth]{figures/bearsDivtime_icytree.pdf}}
