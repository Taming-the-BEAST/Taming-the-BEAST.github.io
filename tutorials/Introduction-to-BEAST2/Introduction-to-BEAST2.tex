...
\item
  ...
  it to the \passthrough{\lstinline!human-chimp!} taxon set. (Note that
  the arrows may not render in BEAST 2.7.
  \textbf{\textgreater\textgreater{}} is the top button and
  \textbf{\textless\textless{}} is at the bottom).
\item
