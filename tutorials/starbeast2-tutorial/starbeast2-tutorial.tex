...
\headsep = 20pt
\lhead{ }
\rhead{\textsc {StarBEAST2 v1.0.0 tutorial}}
\thispagestyle{plain}
...
\begin{center}
  ...
  \textbf{\LARGE StarBEAST2 v1.0.0 tutorial}\\\vspace{2mm}

  % Enter a short description of your tutorial here
  \textbf{\textcolor{mycol}{\Large Estimating species trees using StarBEAST2}}\\

  \vspace{4mm}

  % Enter the names of all the authors here
  {\Large {\em Huw A. Ogilvie (\url{huw.a.ogilvie@rice.edu})}} \\
  {\Large {\em Department of Computer Science, Rice University, Houston, Texas}}
